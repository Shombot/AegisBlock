...
public class AAAProverBasicDLSchnorrExample {
	public static void main(String[] args) throws IOException, ClassNotFoundException, MultipleTrueProofException, NoTrueProofException, ArraySizesDoNotMatchException {
		...
		BigInteger x = ZKToolkit.random(p, rand);
		...
		CryptoData secrets;
		{
			BigInteger r = ZKToolkit.random(p, rand);
			BigInteger[] inner = new BigInteger[] {r, x};
