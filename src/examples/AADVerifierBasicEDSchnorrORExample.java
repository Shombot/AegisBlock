...
public class AADVerifierBasicEDSchnorrORExample {
	public static void main(String[] args) throws IOException, ClassNotFoundException, MultipleTrueProofException, NoTrueProofException, ArraySizesDoNotMatchException {
		...
		GroupElement gUnwrapped = spec.getB();
		Curve cUnwrapped = spec.getCurve();	
		ECPointWrapper g = new Ed25519Point(gUnwrapped);
		ECCurveWrapper c = new Ed25519Curve(cUnwrapped);
		...
		System.out.println("running verify");
