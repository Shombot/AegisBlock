...
public class Fiat_Shamir_AADVerifierBasicECSchnorrORExample {
	public static boolean verifier(String[] args, int n, int i_real) throws IOException, ClassNotFoundException, MultipleTrueProofException, NoTrueProofException, ArraySizesDoNotMatchException, InterruptedException {
		//int n = 50000;
		//int i_real = 29;
		...
		boolean worked = proof.verifyFiatShamir(publicInputs, transcript[0], transcript[1], env2);
