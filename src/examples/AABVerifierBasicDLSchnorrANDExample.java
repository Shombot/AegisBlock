...
public class AABVerifierBasicDLSchnorrANDExample {
	public static void main(String[] args) throws IOException, ClassNotFoundException, MultipleTrueProofException, NoTrueProofException, ArraySizesDoNotMatchException {
		...
		BigInteger y1 = (BigInteger) in.readObject();
		...
		DLPedersenCommitment cCom = new DLPedersenCommitment(challenge[0], challenge[1], commEnv);
